...
```{r, echo=FALSE}
knitr::include_graphics("./monstromedico.png", dpi=300)
```
...
## Juntando tudo no Rscript <font style="background-color:#F7CB45;">gestantes.R</font>
...
```{r, echo=FALSE}
knitr::include_graphics("./moeda400reis.png", dpi=300)
```
<!-- ![](moeda400reis.png) -->

## Moeda é um exemplo em saúde?
```{r, echo=FALSE}
knitr::include_graphics("./moedasHeadTail.png", dpi=150)
knitr::include_graphics("./moedasHeadTailTexto.png", dpi=150)
```
...
knitr::include_graphics("coruja.png", dpi=150)
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("SimulaMoedas01.png", dpi=100)
```
...
```{r, echo=FALSE}
knitr::include_graphics("jornalista01.png", dpi=150)
knitr::include_graphics("jornalista02.png", dpi=150)
knitr::include_graphics("jornalista03.png", dpi=150)
knitr::include_graphics("jornalista04.png", dpi=150)
knitr::include_graphics("jornalista05.png", dpi=150)
```
...
```{r, echo=FALSE}
knitr::include_graphics("jornalista06.png", dpi=150)
```
...
```{r, echo=FALSE}
knitr::include_graphics("SimulaMoedas02.png", dpi=100)
```
...
(de declarar a diferença acertadamente).
</td>
</tr>
</table>
</div>
...
```{r, echo=FALSE}
knitr::include_graphics("jornalista07.png", dpi=150)
```
...
Aplicando-se o novo método aplicado a 78 crianças:
 ...
 - se somente até 46 crianças aprenderem higiene pessoal, não podemos rejeitar $H_0$. No entanto, como escolhemos poder de $90\%$ **antes do iniciarmos o estudo**, podemos aceitar $H_0$ e afirmar que os dois tratamentos são iguais porque a igualdade não deve ser decorrente de insuficiência amostral (no entanto, podemos estarm enganados e, na verdade, o novo tratamento ser melhor, com $\beta=10\%$ de probabilidade).
...
```{r, echo=FALSE}
knitr::include_graphics("distnormal.png", dpi=100)
```

## simetria
É uma distribuição simétrica, portanto média, moda e mediana coincidem:
```{r, echo=FALSE}
knitr::include_graphics("distnormal0dp.png", dpi=100)
```
...
```{r, echo=FALSE}
knitr::include_graphics("distnormal1dp.png", dpi=100)
```
...
```{r, echo=FALSE}
knitr::include_graphics("distnormal2dp.png", dpi=100)
```

### $\pm 3 dp$
cerca de 99.7% da área entre -3 e +3 desvio-padrão:
```{r, echo=FALSE}
knitr::include_graphics("distnormal3dp.png", dpi=100)
```
...
O seguinte código usa a função _**rnorm()**_ para criar, usando um gerador de números pseudo-aleatórios (_**r**andom_), uma população com 10000 indivíduos:
```{r, echo=TRUE}
...
A íntegra do _Rscript_ que será desenvolvido adiante está em <font style="background-color:#F7CB45;"> Bootstrapping_populacaoXamostra.R</font>
</small></div>
...
O TCL estabelece que a distribuição das médias amostrais, independentemente da forma da distribuição da população original tem distribuicao NORMAL com média igual à média da população e com certo desvio-padrão.
...
Você pode executar o _Rscript_ <font style="background-color:#F7CB45;"> Populacao_e_EPM.R</font>
```{r, echo=FALSE}
# Populacao_e_EMP.R
...
```{r, echo=FALSE}
knitr::include_graphics("boot_strap.png", dpi=100)
```
